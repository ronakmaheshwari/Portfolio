            ...
            <div className="grid gap-6">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                  ...
                  <span className="bg-green-900/20 px-3 py-1 rounded">Java</span>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                  ...
                  <span className="bg-green-900/20 px-3 py-1 rounded">HonoJs</span>
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                  ...
                  <span className="bg-green-900/20 px-3 py-1 rounded">Cloudflare</span>
                  <span className="bg-green-900/20 px-3 py-1 rounded">GCP</span>
